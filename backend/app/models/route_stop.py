...
class RouteStop(Base):
    ...
    planned_arrival_min: Mapped[int | None] = mapped_column(sa.Integer, nullable=True)
    assigned_slot_code: Mapped[str | None] = mapped_column(sa.String(10), nullable=True)
    predicted_home_prob: Mapped[float | None] = mapped_column(sa.Float, nullable=True)
