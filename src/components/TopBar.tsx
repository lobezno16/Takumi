...
import { Play, Check, CloudLightning, Calendar, RefreshCw, Download } from "lucide-react";

export default function TopBar() {
  const { currentPage, selectedDate, setSelectedDate, triggerReoptimization } = useDeliveryStore();
  ...
  const handleRunOptimization = () => {
    ...
    addEvent({
      ...
      message: "VRP Solver recalculation requested. Loading current Koto-ku traffic & stop predictions...",
    ...
    setTimeout(() => {
      ...
      addEvent({
        ...
        recipient_name: "Fleetwide",
        message: "Dynamic OR-Tools VRP recalculation finished. All 8 routes fully optimized (Saved 3.1h total).",
        timestamp: new Date().toLocaleTimeString("ja-JP", { hour12: false })
      });
    }, 1500);
  };
